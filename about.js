/* ============================================
   about.js — Professional GreenEnergy About Page
   ============================================ */
...
function forceActiveAbout() {
    document.querySelectorAll('.nav-links a').forEach(l => l.classList.remove('active'));
    if (aboutLink) aboutLink.classList.add('active');
}
forceActiveAbout();
window.addEventListener('scroll', forceActiveAbout, { passive: true });
...
const statsBar = document.querySelector('.about-hero-stats');
...
/* ===========================
   TIMELINE — staggered dots
=========================== */
const tlItems = document.querySelectorAll('.timeline-item');
const tlObs = new IntersectionObserver((entries) => {
    entries.forEach((entry, i) => {
        if (entry.isIntersecting) {
            // Slight extra delay per item for cascading feel
...
tlItems.forEach(item => {
    // Timeline items also carry reveal class, handled by revealObs already
    // but we add the observer for the stagger as well
    tlObs.observe(item);
});
